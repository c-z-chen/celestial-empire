...
surnamesWeighted: [
    {value: "王", weight: 90}, {value: "李", weight: 90}, {value: "张", weight: 90},
    {value: "刘", weight: 85}, {value: "陈", weight: 85}, {value: "杨", weight: 75},
    {value: "赵", weight: 70}, {value: "黄", weight: 60}, {value: "周", weight: 55},
    ...
    {value: "唐", weight: 8}, {value: "许", weight: 8}, {value: "韩", weight: 8},
    {value: "邓", weight: 8}, {value: "冯", weight: 8}, {value: "方", weight: 8},
    {value: "曹", weight: 6}, {value: "彭", weight: 6}, {value: "曾", weight: 6},
    {value: "萧", weight: 5}, {value: "董", weight: 5}, {value: "袁", weight: 5},
    {value: "潘", weight: 5}, {value: "蔡", weight: 5}, {value: "余", weight: 5},
    {value: "杜", weight: 5}, {value: "戴", weight: 5}, {value: "夏", weight: 5},
    {value: "钟", weight: 5}, {value: "汪", weight: 5}, {value: "田", weight: 4},
    {value: "任", weight: 4}, {value: "姜", weight: 4}, {value: "范", weight: 4},
    {value: "石", weight: 4}, {value: "姚", weight: 4}, {value: "谭", weight: 4},
    {value: "廖", weight: 4}, {value: "邹", weight: 4}, {value: "熊", weight: 4},
    {value: "金", weight: 4}, {value: "陆", weight: 4}, {value: "郝", weight: 3},
    {value: "孔", weight: 3}, {value: "白", weight: 3}, {value: "崔", weight: 3},
    {value: "康", weight: 3}, {value: "毛", weight: 3}, {value: "邱", weight: 3},
    {value: "秦", weight: 3}, {value: "江", weight: 3}, {value: "史", weight: 3},
    {value: "顾", weight: 3}, {value: "侯", weight: 3}, {value: "邵", weight: 3},
    {value: "龙", weight: 2}, {value: "万", weight: 2}, {value: "段", weight: 2},
    {value: "雷", weight: 2}, {value: "钱", weight: 2}, {value: "汤", weight: 2},
    {value: "尹", weight: 2}, {value: "黎", weight: 2}, {value: "易", weight: 2},
    {value: "乔", weight: 2}, {value: "文", weight: 2}, {value: "闫", weight: 2}
],

    zibeiPool: Array.from("允文遵祖训钦武大君胜顺道宜逢吉师良善用晟尚志公诚秉惟怀敬谊存辅嗣资廉直匡时永信惇济美锺奇表知新慎敏求审心咸景慕述学继前修高瞻祁见祐厚载翊常由慈和怡伯仲简靖迪先猷有子同安睦勤朝在肃恭绍伦敷惠润昭格广登庸孟季均荣显英华蕴盛容宏才升博衍茂士立全功贤能长可庆睿智实堪宗养性期渊雅寅思复会通肇泰阳当健观颐寿以弘振举希兼达康庄遇本宁悦友申宾让承宣奉至平懋进深滋益端居务穆清久镇开方岳扬威谨礼仪刚毅循超卓权衡素自持逊仕成聪俊充廷鼐鼎彝传贻连秀郁炳燿壮洪基赡禄贡真弼缙绅识烈忠省衡岳毓灵秀沧海映朝晖熙溪君伯桦居重世成仍祺保合"),
    givenChars: Array.from("德恩泽渊浩宇霖翰廷栋伯仲叔季天明国正世广大宏志道学立生希绍茂士汝时清之懋修齐治平坚刚健伟达全仁义礼智信诚敬轩景泰元亨利尘时中贞文武斌辉豪杰俊英光华博雅致远宁静克己复礼钦林澟山水望知隶理器督期思斯工府朝庭绅士间云帆济川启瑞承宣维桢致远明哲思诚俊朗浩初秉钧怀瑾佩瑜熙溪熹涪福雅玢胤运脩楷峭绩妙业察法璟珩谦毅淳恒隆昆玉泉金崇原谘咨资访宪术俨岩严尊儒"),
