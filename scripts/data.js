const EconomyLvls = ["凋敝", "贫困", "平平", "富庶", "繁华"];
const MilitaryEconomyLvls = ["苦寒戍边", "军屯自给", "粮草充足", "军备森严"];

const BaseIndustries = ["农业", "商业", "矿业", "林木", "丝织", "茶业", "瓷器", "药材", "畜牧"];
const CoastalSpecialties = ["渔业", "盐业", "海贸", "造船", "采珠"];
const CapitalVicinityIndustries = ["御窑织造", "百业行会", "皇庄贡品", "京通仓储"];
...
const NameGen = {
    ...
    zibeiPool: Array.from("允文遵祖训钦武大君胜顺道宜逢吉师良善用晟尚志公诚秉惟怀敬谊存辅嗣资廉直匡时永信惇济美锺奇表知新慎敏求审心咸景慕述学继前修高瞻祁见祐厚载翊常由慈和怡伯仲简靖迪先猷有子同安睦勤朝在肃恭绍伦敷惠润昭格广登庸孟季均荣显英华蕴盛容宏才升博衍茂士立全功贤能长可庆睿智实堪宗养性期渊雅寅思复会通肇泰阳当健观颐寿以弘振举希兼达康庄遇本宁悦友申宾让承宣奉至平懋进深滋益端居务穆清久镇开方岳扬威谨礼仪刚毅循超卓权衡素自持逊仕成聪俊充廷鼐鼎彝传贻连秀郁炳燿壮洪基赡禄贡真弼缙绅识烈忠省衡岳毓灵秀沧海映朝晖熙溪君伯桦居重世"),
    givenChars: Array.from("德恩泽渊浩宇霖翰廷栋伯仲叔季天明国正世广大宏志道学立生希绍茂士汝时清之懋修齐治平坚刚健伟达全仁义礼智信诚敬轩景泰元亨利尘时中贞文武斌辉豪杰俊英光华博雅致远宁静克己复礼钦林澟山水望知隶理器督期思斯工府朝庭绅士戬云帆济川启瑞承宣维桢致远明哲思诚俊朗浩初秉钧怀瑾佩瑜熙溪熹涪福雅玢胤运脩楷峭"),
